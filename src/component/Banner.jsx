...
const Banner = () => {
  return (
    <div className="relative min-h-162.5 flex items-center overflow-hidden sm:m-t-20">
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight tracking-tighter text-orange-600">
            Supercharge Your
            <br />
            <span className="bg-linear-to-r from-red-400 via-orange-400 to-amber-400 bg-clip-text text-transparent">
              Digital Workflow
          ...
          <div className="flex flex-wrap  gap-4 pt-4">
            <button className="btn bg-linear-to-r from-red-400 via-orange-400 to-amber-400 transition-all px-4 py-6 rounded-3xl font-semibold text-lg shadow-xl shadow-red-500/30 flex items-center gap-3 group text-white border-none">
              Explore Products
            </button>
